...
static rt_size_t blk_dev_write(rt_device_t dev, rt_off_t pos, void const* buffer, rt_size_t size) {
    int ret = 0;
...
static rt_size_t mtd_nor_dev_read(struct rt_mtd_nor_device* device, rt_off_t offset, rt_uint8_t* data,
                                  rt_uint32_t length) {
    int ret = 0;
...
static rt_size_t mtd_nor_dev_write(struct rt_mtd_nor_device* device, rt_off_t offset, rt_uint8_t const* data,
                                   rt_uint32_t length) {
    int ret = 0;
...
static rt_size_t char_dev_write(rt_device_t dev, rt_off_t pos, void const* buffer, rt_size_t size) {
    int ret = 0;
...
static int char_dev_fwrite(struct dfs_fd* fd, void const* buf, size_t count) {
    int ret = 0;
    struct fal_char_device* part = (struct fal_char_device*)fd->data;
